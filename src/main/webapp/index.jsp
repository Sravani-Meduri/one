...
<body>
    ...
    <header>
        <div class="container header-inner">
            ...
            <nav class="main-nav" id="mainNav" aria-label="Main navigation">
                <ul>
                    <li><a href="#" class="active"><span class="fas fa-home"></span> Home</a></li>
                    <li><a href="#categories"> class="fas fa-th-large"></span> Categories</a></li>
                    <li><a href="#products"><span class="fas fa-fire"></span> Trending</a></li>
                    <li><a href="#deals"><span class="fas fa-tag"></span> Deals</a></li>
                    <li><a href="#testimonials"><span class="fas fa-star"></span> Reviews</a></li>
                </ul>
            </nav>

            <div style="display:flex;align-items:center;gap:10px;">
                <div class="search-wrap" role="search">
                    <spannput type="search" id="searchInput" placeholder="Search products..." aria-label="Search" />
                    <button id="searchBtn" aria-label="Submit search"><span class="fas fa-search"></span></button>
                </div>

                <div class="header-actions">
                    <button class="icon-btn" title="Account" aria-label="Account"><span class="far fa-user"></span></button>
                    <button class="icon-btn" title="Wishlist" aria-label="Wishlist"><span class="far fa-heart"></span></button>
                    <div class="cart-wrap">
        ...
        <div id="mobileMenu">
            <div class="container">
                <ul>
                    ...
                    <li><a href="#categories"><span class="fas fa-th-large"></span> Categories</a></li>
                    <li><a href="#products"><span class="fas fa-fire"></span> Trending</a></li>
                    <li><a href="#deals"><span class="fas fa-tag"></span> Deals</a></li>
                    <li><a href="#testimonials"><span class="fas fa-star"></span> Reviews</a></li>
                    <li><a href="#"><span class="far fa-user"></span> Account</a></li>
                    <li><a href="#"><span class="far fa-heart"></span> Wishlist</a></li>
                </ul>
            </div>
        </div>
    </header>
    ...
    <main>
        ...
        <section class="hero" aria-label="Hero banner">
            <div class="container">
                <div class="badge"><span class="fas fa-sparkles"></span> New Collection 2026</div>
                ...
                <div class="actions">
                    <button class="btn btn-primary" id="shopNow"><span class="fas fa-arrow-right"></span> Shop Now</button>
                    <button class="btn btn-ghost" id="exploreDeals"><span class="fas fa-clock"></span> Explore Deals</button>
                </div>
            </div>
        </section>
        ...
        <section class="section" id="categories" aria-labelledby="cat-title">
            <div class="container">
                <div class="section-header">
                    ...
                    <a href="#" class="view-all">All Categories <span class="fas fa-arrow-right"></span></a>
                </div>
        ...
        <section class="section" id="products" aria-labelledby="prod-title">
            <div class="container">
                <div class="section-header">
                    ...
                    <a href="#" class="view-all">View All <span class="fas fa-arrow-right"></span></a>
                </div>
        ...
        <section class="section" id="deals" aria-labelledby="deals-title">
            <div class="container">
                ...
                <div class="deal-wrap">
                    <div class="deal-img">
                        <spanmg src="https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=800&q=80" alt="MacBook Air M2" loading="lazy">
                    </div>
                    <div class="deal-content">
                        <span class="tag"><span class="fas fa-bolt"></span> Limited Offer</span>
                        ...
                        <button class="btn btn-primary" id="buyDeal"><span class="fas fa-cart-plus"></span> Add to Cart</button>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="newsletter-wrap">
                    ...
                    <form id="newsletterForm" onsubmit="return false;">
                        <spannput type="email" id="newsletterEmail" placeholder="Enter your email" aria-label="Email" required />
                        <button class="btn" id="subscribeBtn"><span class="fas fa-paper-plane"></span> Subscribe</button>
            ...
            <div class="footer-grid">
                <div class="brand-col">
                    ...
                    <div class="socials">
                        ...
                        <a href="#" aria-label="YouTube"><span class="fab fa-youtube"></span></a>
                    </div>
                </div>
                <div class="col">
                    <h5>Company</h5>
    ...
    <script>
        ...
        function renderCategories() {
            ...
            CATEGORIES.forEach(cat => {
                ...
                el.innerHTML = `
                    <div class="icon-wrap"><span class="fas ${cat.icon}"></span></div>
                    <h4>${cat.name}</h4>
        ...
        function renderProducts(list) {
            ...
            list.forEach(p => {
                ...
                el.innerHTML = `
                    <div class="img-wrap">
                        <spanmg src="${p.img}" alt="${escapeHtml(p.title)}" loading="lazy">
                        ${badgeHtml}
                        <button class="wish-btn" aria-label="Add to wishlist"><span class="far fa-heart"></span></button>
                    </div>
                    <div class="body">
                    ...
                    <div class="footer">
                        <button class="add-btn" data-id="${p.id}"><span class="fas fa-cart-plus"></span> Add</button>
                    </div>
                `;
        ...
        function renderTestimonials() {
            ...
            TESTIMONIALS.forEach(t => {
                ...
                el.innerHTML = `
                    ...
                    <div class="author">
                        <spanmg class="avatar" src="${t.avatar}" alt="${escapeHtml(t.name)}" loading="lazy">
                        <div>
        ...
        function addToCart(productId, btnEl) {
            ...
            if (btnEl) {
                ...
                btnEl.innerHTML = '<span class="fas fa-check"></span> Added';
        ...
        mobileToggle.addEventListener('click', () => {
            ...
            mobileToggle.innerHTML = isOpen ? '<span class="fas fa-bars"></span>' : '<span class="fas fa-times"></span>';
        });
        ...
        mobileMenu.querySelectorAll('a').forEach(link => {
            link.addEventListener('click', () => {
                ...
                mobileToggle.innerHTML = '<span class="fas fa-bars"></span>';
            });
        });
        ...
        document.getElementById('buyDeal').addEventListener('click', function() {
            ...
            this.innerHTML = '<span class="fas fa-check"></span> Added!';
